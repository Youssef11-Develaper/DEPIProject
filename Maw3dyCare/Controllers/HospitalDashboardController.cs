...
namespace Maw3dyCare.Controllers
{
    ...
    public class HospitalDashboardController : Controller
    {
     ...
     IHubContext<ReservationHub> hub)
        ...
        public IActionResult Index()
        {
            ...
            int pendingCount = _db.Reservation
        ...
        //    var bed = _db.Bed.FirstOrDefault(b =>
        ...
        public async Task<IActionResult> AcceptReservation(int id)
        {
            ...
            // ابحث عن أول سرير متاح من نفس النوع
            var availableBed = _db.Bed
            ...
            // حوّل السرير لـ Occupied
            availableBed.Status = "Occupied";

            // ← احفظ الـ BedId في الحجز
            reservation.Status = "Accepted";
    ...
    .SendAsync("StatusChanged", "Rejected");
        ...
        {
            ViewBag.BedTypes = _db.BedType.ToList();
              ...
              public IActionResult ManageBeds(string? search, string? filterType, string? filterStatus)
        {
            ...
            var acceptedReservations = _db.Reservation
        ...
        public IActionResult EditBedStatus(int bedId, string newStatus)
        {
            ...
            var bed = _db.Bed.FirstOrDefault(b => b.BedId == bedId && b.HospitalId == hospitalId);
        ...
        public IActionResult BlockPhone(BlockPhoneVM vm)
        {
            ...
            if (!ModelState.IsValid)
            {
                ViewBag.BlockedList = _db.BlockedPhone
                    .Where(b => b.HospitalId == hospitalId)
                    .OrderByDescending(b => b.BlockedAt)
                    .Select(b => new BlockedUserVM
                    {
            ...
            bool alreadyBlocked = _db.BlockedPhone.Any(b =>
            ...
            _db.BlockedPhone.Add(new BlockedPhones
            {
                Phone = vm.Phone,
                HospitalId = hospitalId,
                Reason = vm.Reason,
        ...
        public IActionResult UnblockPhone(int id)
        {
            ...
            if (blocked != null)
            {
                _db.BlockedPhone.Remove(blocked);
                _db.SaveChanges();
            }
