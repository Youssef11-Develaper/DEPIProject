...
{
    /// <inheritdoc />
    public partial class AddCourtsTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourtServices", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CourtDepartments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourtDepartments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourtDepartments_Courts_CourtId",
                        column: x => x.CourtId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WantsSms = table.Column<bool>(type: "bit", nullable: false),
                    WantsReminder = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_CourtDepartments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "CourtDepartments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bookings_CourtServices_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "CourtServices",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LegalCases_CourtDepartments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "CourtDepartments",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QueueTickets_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_QueueTickets_Courts_CourtId",
                        column: x => x.CourtId,
                        principalTable: "Courts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CaseTimelineEvents_LegalCases_LegalCaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaseTimelineEvents_LegalCaseId",
                table: "CaseTimelineEvents",
                column: "LegalCaseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourtDepartments_CourtId",
                table: "CourtDepartments",
                column: "CourtId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueueTickets_BookingId",
                table: "QueueTickets",
                column: "BookingId",
                unique: true,
